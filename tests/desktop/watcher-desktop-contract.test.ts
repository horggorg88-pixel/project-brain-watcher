...
describe('watcher desktop contract', () => {
  ...
  it('exposes passive service status and copy logs in the watcher panel', () => {
    ...
    expect(iconSource).toContain("| 'activity'");
    expect(iconSource).toContain("| 'package-search'");
    expect(serviceUiSource).toContain("health: 'activity'");
    expect(serviceUiSource).toContain("check_update: 'package-search'");
    expect(serviceUiSource).toContain("button.toggleAttribute('data-confirmation-pending'");
    expect(serviceUiSource).toContain("button.dataset.commandVariant = 'danger'");
    ...
    expect(baseCss).toContain('html::-webkit-scrollbar-thumb');
    expect(baseCss).toContain('body::-webkit-scrollbar-thumb');
    expect(baseCss).toContain('.app-shell::-webkit-scrollbar-thumb');
    expect(baseCss).toContain('::-webkit-scrollbar-thumb');
    expect(baseCss).toContain('background-clip: padding-box;');
    ...
    expect(componentsCss).toContain('.service-icon-button[data-confirmation-pending="true"]');
    expect(componentsCss).toContain('animation: confirmPulse');
    expect(componentsCss).toContain('.toggle.off');
    expect(componentsCss).toContain('animation: toggleOffGlow');
